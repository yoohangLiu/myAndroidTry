...
public class SimpleCategoryTouchHelperCallback extends ItemTouchHelper.Callback {
    private final ItemTouchHelperAdapter mAdapter ;

    public SimpleCategoryTouchHelperCallback(ItemTouchHelperAdapter mAdapter) {
