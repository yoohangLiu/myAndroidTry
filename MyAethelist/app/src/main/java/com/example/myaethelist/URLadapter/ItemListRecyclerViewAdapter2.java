...
import com.example.myaethelist.NetworkModel.Item;
 ...
 */
public class ItemListRecyclerViewAdapter2 extends RecyclerView.Adapter<ItemListViewHolder> implements ItemTouchHelperAdapter {
    private List<com.example.myaethelist.NetworkModel.Item> ItemList;
   ...
   /* private ImageRequester imageRequester;*/
    ...
    public ItemListRecyclerViewAdapter2(List<com.example.myaethelist.NetworkModel.Item> ItemList) {
    ...
    public void onBindViewHolder(@NonNull ItemListViewHolder holder, int position) {
        if (ItemList != null && position < ItemList.size()) {
            ...
            holder.ItemTitle.setText(product.getItem_name());
